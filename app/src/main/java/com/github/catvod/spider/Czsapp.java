...
public class Czsapp extends Spider {
    ...
    private static final Pattern btwaf = Pattern.compile("(?<=btwaf=).*?(?=\")");
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        try {
            ...
            String Contentw = OkHttpUtil.string("https://www.czzzu.com/" + str + "/page/" + str2, getHeaders());
            Document doc = null;
            ...
            String bttime = "";
             ...
             doc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/" + str + "/page/" + str2 + "?btwaf=" + bttime, getHeaders()));
            
            }
            
            if(Contentw.contains("huadong") || Contentw.contains("renji"))
            {
             doc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/" + str + "/page/" + str2, Headers()));
            }
            if(Contentw.contains("http://open.weibo.com/wb"))
            {
    ...
    public String detailContent(List<String> list) {
        ...
        try {
            ...
            JSONArray jSONArray = new JSONArray();
            JSONObject jSONObject2 = new JSONObject();
String Contentw = OkHttpUtil.string("https://www.czzzu.com/movie/" + list.get(0) + ".html", getHeaders());
            Document doc = null;
            if(Contentw.contains("btwaf")){
            Matcher bttime1 = btwaf.matcher(Contentw);     
            String bttime = "";
             ...
             doc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/movie/" + list.get(0) + ".html?btwaf=" + bttime, getHeaders()));
            
            }
            
            if(Contentw.contains("huadong") || Contentw.contains("renji"))
            {
             doc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/movie/" + list.get(0) + ".html", Headers()));
            }
            if(Contentw.contains("http://open.weibo.com/wb")){
				 doc = Jsoup.parse(Contentw);
            }
    ...
    public String homeContent(boolean z) {
        try {
            JSONObject jSONObject = new JSONObject();
            String Contentw = OkHttpUtil.string("https://www.czzzu.com/", getHeaders());
            Document doc = null;
            if(Contentw.contains("btwaf")){
            Matcher bttime1 = btwaf.matcher(Contentw);     
            String bttime = "";
             ...
             doc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/?btwaf=" + bttime, getHeaders()));
            
            }
            
            if(Contentw.contains("huadong") || Contentw.contains("renji"))
            {
             doc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/", Headers()));
            }
            if(Contentw.contains("http://open.weibo.com/wb")){
				doc = Jsoup.parse(Contentw);
            }
        ...
        hashMap.put("referer", "https://www.czzzu.com");
        return hashMap;
        }
    ...
    protected   static HashMap<String, String> Headers() throws IOException{
        ...
        String Content = OkHttpUtil.string("https://www.czzzu.com/", getHeaders());
	    ...
	    String jsurl ="https://www.czzzu.com/" + ids;
        String jskey = OkHttpUtil.string(jsurl, getHeaders());	
		Matcher matcher2 = key2.matcher(jskey);
		if (matcher2.find()) {
		jskeys = matcher2.group(0);	
		}
	    URL url = new URL("https://www.czzzu.com/a20be899_96a6_40b2_88ba_32f1f75f1552_yanzheng_huadong.php?type=ad82060c2e67cc7e2cc47552a4fc1242&key="+jskeys+"&value=8174fb7ee891963498d5dbeddf20bc53");
        ...
        conn.setRequestProperty("Referer" , "https://www.czzzu.com/");
       
      
		cookie = conn.getHeaderField("Set-Cookie");
		}
		if(ids.contains("renji")) {     
		String jsurl2 ="https://www.czzzu.com/" + ids;
        String jskey = OkHttpUtil.string(jsurl2, getHeaders());	
        Matcher matcher3 = key.matcher(jskey);
        if (matcher3.find()) {
        jskeys = matcher3.group(0);
        }
        URL url = new URL("https://www.czzzu.com/a20be899_96a6_40b2_88ba_32f1f75f1552_yanzheng_ip.php?type=96c4e20a0e951f471d32dae103e83881&key="+jskeys+"&value=b9c1b06534ddb490f6d5bfcf6d038bc8");
        ...
        if(Content.contains("http://open.weibo.com/wb")){
          cookie = null;
        }
    ...
    public String playerContent(String str, String str2, List<String> list) {
        ...
        try {
               String K2 = "";    
               String urlPlay = "https://www.czzzu.com/v_play/" + str2 + ".html";       
			   String  KK3 = OkHttpUtil.string(urlPlay, getHeaders());
            ...
            String bttime = "";
             ...
             K2 =OkHttpUtil.string("https://www.czzzu.com/v_play/" + str2 + ".html?btwaf=" + bttime, getHeaders());
            
            }
            
            if(KK3.contains("huadong") || KK3.contains("renji"))
            {
             K2 =OkHttpUtil.string("https://www.czzzu.com/v_play/" + str2 + ".html", Headers());
            }
			if(KK3.contains("http://open.weibo.com/wb")){
				K2 = KK3;
			}
    ...
    public String searchContent(String str, boolean z) {
        try {
            JSONObject jSONObject = new JSONObject();
            Document docc = null;
            String shuru = URLEncoder.encode(str);
            String Contents = OkHttpUtil.string("https://www.czzzu.com/?s=大厂长大大求饶命&btwaf=93094563", getHeaders());
            String bttimeo = "";
            ...
            Matcher bttime = btwaf.matcher(Contents);     
             ...
             docc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/?s=" + shuru + "&btwaf=" + bttimeo, getHeaders2()));
            }
            if(Contents.contains("form action=\"\" method=\"post\"")){
            docc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/?s=" + shuru, getHeaders2()));
            }
            if(Contents.contains("huadong") || Contents.contains("s=renji"))
            {
             docc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/?s=" + shuru, Headers()));
            }
            if(Contents.contains("http://open.weibo.com/wb"))
            {
				 docc = Jsoup.parse(OkHttpUtil.string("https://www.czzzu.com/?s=" + shuru, getHeaders()));
            }        
            Elements jS =docc.select("div.mi_ne_kd > ul > li");
            JSONArray jSONArray = new JSONArray();
            for (Element next : jS) {
                ...
                if (matcher.find()) {
                    ...
                    if (trim.contains(str)) {
                        ...
                        if (next.hasClass(".jidi")) {
                            ...
                            Document doc = Jsoup.parse(OkHttpUtil.string(id, getHeaders()));
