...
public class AppTT2 extends Spider {
    private String KEY = "SRK#e%4UYtU#KiEo*vsPqpr0cC4bxAQW"; //U1JLI2UlNFVZdFUjS2lFbyp2c1BxcHIwY0M0YnhBUVc=
    private String IV = "o6sYmm*x5hn#rcCt";//bzZzWW1tKng1aG4jcmNDdA==
    private String siteUrl = "http://124.248.68.16:6611";
    ...
    public void init(Context context, String extend) {
        ...
        String url = strs[0];
        if (strs.length > 2) {
            KEY = new String(Base64.decode(strs[1], Base64.NO_WRAP));
            IV = new String(Base64.decode(strs[2], Base64.NO_WRAP));
        }
        siteUrl = url;
    }
