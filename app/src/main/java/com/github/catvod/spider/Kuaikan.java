                    ...
                    try {
                        ...
                        for (int i = 0; i < jSONArray2.length(); i++) {
                            ...
                            if (i2 > 0) {
                                ...
                                new JSONArray();
                                OkHttpUtil.postJson(OkHttpUtil.defaultClient(), "http://ctlook.facaishiyi.com/api/v1/search/category.do", jSONObject8.toString(), Kuaikan.this.j(currentTimeMillis2), new OKCallBackString() { // from class: com.github.catvod.spider.Kuaikan.3.1
                                    @Override
                                    public void onFailure(Call call, Exception exc) {
                                    }
